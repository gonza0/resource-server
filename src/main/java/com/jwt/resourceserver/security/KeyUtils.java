...
public class KeyUtils {
    ...
    private KeyPair getAccesTokenKeyPair() {
    ...
    private KeyPair getKeyPair(String publicKeyPath, String privateKeyPath) {
        ...
        if (publicKeyFile.exists() && privateKeyFile.exists()) {
            ...
            if(Arrays.stream(environment.getActiveProfiles()).anyMatch(profile -> profile.equals("prod"))){
    ...
    public RSAPublicKey getAccessTokenPublicKey() {
        return (RSAPublicKey) getAccesTokenKeyPair().getPublic();
    }

    public RSAPrivateKey getAccessTokenPrivateKey() {
        return (RSAPrivateKey) getAccesTokenKeyPair().getPrivate();
    }
